 ...
 * @author Samsung
 */
public class FormRecepcionista extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        painelCadastro.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro Recepcionista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
                ...
                .addGroup(painelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelCadastroLayout.createSequentialGroup()
                        ...
                        .addGroup(painelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cbxEstado, 0, 190, Short.MAX_VALUE))
                        .addGap(45, 45, 45))))
        );
        ...
        painelBusca.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Recepcionista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Recepcionista recepcionista = new Recepcionista(nome, txtCpf.getText(), txtEmail.getText(), txtTelefone.getText(), endereco, dataNascimento);
        
        if(new BRecepcionista().cadastrarRecepcionista(recepcionista)){
            JOptionPane.showMessageDialog(null, "Recepcionista Cadastrada com Sucesso!");
            listarRecepcionistas();
        } else{
            JOptionPane.showMessageDialog(null, "Erro ao cadastrar Recepcionista", "Erro de cadastro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void pbBtnBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pbBtnBuscaActionPerformed
        ...
        if(pbTxtId.getText().equals("") && pbTxtNome.getText().equals("") && pbTxtCpf.getText().equals("   .   .   -  ")){
            List<Recepcionista> lista = new BRecepcionista().getRecepcionistas();
            RecepcionistaTableModel ptm = new RecepcionistaTableModel(lista);
            tabela.setModel(ptm);
        }
        //busca pelo id
        else if (!pbTxtId.getText().equals("")){
                Recepcionista recep = new BRecepcionista().getRecepcionista(Integer.parseInt(pbTxtId.getText()));
                FormAtualizarRecepcionista fap = new FormAtualizarRecepcionista(recep);
        ...
        //busca pelo cpf
                ...
                Recepcionista recep = new BRecepcionista().getRecepcionista(pbTxtCpf.getText());
                lista.add(recep);
                RecepcionistaTableModel ptm = new RecepcionistaTableModel(lista);
                tabela.setModel(ptm);
        }
        //busca pelo nome
                ...
                List<Recepcionista> lista = new BRecepcionista().getRecepcionistas(pbTxtNome.getText());
                RecepcionistaTableModel ptm = new RecepcionistaTableModel(lista);
                tabela.setModel(ptm);
        }
    ...
    protected void listarRecepcionistas(){
        preparaTabela();
        tabela.setModel(modelo);
