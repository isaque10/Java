 ...
 * @author Samsung
 */
public class FormAtualizarDentista extends javax.swing.JFrame {

    /**
     * Creates new form FormAtualizarPaciente
     */
    public FormAtualizarDentista(Dentista d) {
        initComponents();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(bd.atualizarDentista(d)){
            JOptionPane.showMessageDialog(null, "Dentista Atualizado!");
            limparCampos();
            this.setVisible(false);
        }else{
            JOptionPane.showMessageDialog(null, "Erro ao atualizar Dentista!");
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        BDentista bd = new BDentista();
        int excluir = JOptionPane.showConfirmDialog(null, "Deseja excluir o Dentista?");
        
        if(excluir == 0){
            if(bd.excluirDentista(Integer.parseInt(txtId.getText()))){
