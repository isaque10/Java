 ...
 * @author Samsung
 */
public class FormDentista extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pbLblCro = new javax.swing.JLabel();
        ...
        pbTxtCro = new javax.swing.JTextField();
        ...
        painelCadastro.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro Dentista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
        ...
        lblCro.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        lblCro.setText("CRO:");
        ...
        txtCro.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        painelCadastroLayout.setVerticalGroup(
            ...
            .addGroup(painelCadastroLayout.createSequentialGroup()
                ...
                .addGroup(painelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblCro)
                    .addComponent(lblEmail)
                    .addComponent(txtCro, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(painelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(painelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        painelBusca.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Dentista", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
        ...
        pbLblCro.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        pbLblCro.setText("CRO:");
        ...
        pbTxtCro.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
            ...
            .addGroup(painelBuscaLayout.createSequentialGroup()
                ...
                .addGroup(painelBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelBuscaLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(pbLblCro)
                        .addGap(18, 18, 18)
                        .addComponent(pbTxtCro, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(painelBuscaLayout.createSequentialGroup()
                        ...
                        .addGroup(painelBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(painelBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(pbTxtCro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Dentista dentista = new Dentista(nome, sexo, txtCro.getText(), txtEmail.getText(), txtTelefone.getText(), endereco, dataNascimento);
        
        if(new BDentista().cadastrarDentista(dentista)){
            JOptionPane.showMessageDialog(null, "Dentista Cadastrado com Sucesso!");
            listarDentistas();
        } else{
            JOptionPane.showMessageDialog(null, "Erro ao cadastrar Dentista", "Erro de cadastro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void pbBtnBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pbBtnBuscaActionPerformed
        ...
        //busca completa
        if(pbTxtId.getText().equals("") && pbTxtNome.getText().equals("") && pbTxtCro.getText().equals("")){
            List<Dentista> lista = new BDentista().getDentistas();
            DentistaTableModel ptm = new DentistaTableModel(lista);
            tabela.setModel(ptm);
        }
        //busca pelo id
        else if (!pbTxtId.getText().equals("")){
                Dentista dentista = new BDentista().getDentista(Integer.parseInt(pbTxtId.getText()));
                FormAtualizarDentista fap = new FormAtualizarDentista(dentista);
                fap.setLocationRelativeTo(null);  
                fap.setVisible(true);
        }
        //busca pelo cro
        else if(!pbTxtCro.getText().equals("")){
                List<Dentista> lista = new ArrayList<>();
                Dentista dentista = new BDentista().getDentista(pbTxtCro.getText());
                lista.add(dentista);
                DentistaTableModel ptm = new DentistaTableModel(lista);
                tabela.setModel(ptm);
        }
        //busca pelo nome
                ...
                List<Dentista> lista = new BDentista().getDentistas(pbTxtNome.getText());
                DentistaTableModel ptm = new DentistaTableModel(lista);
                tabela.setModel(ptm);
        }
    ...
    protected void listarDentistas(){
        preparaTabela();
        tabela.setModel(modelo);
    ...
    private javax.swing.JLabel pbLblCro;
    private javax.swing.JLabel pbLblId;
    private javax.swing.JLabel pbLblNome;
    private javax.swing.JTextField pbTxtCro;
